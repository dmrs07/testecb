...
var RecipeFilterPipe = (function () {
    ...
    RecipeFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (recipe) { return recipe.recipeName.toLocaleLowerCase().indexOf(filterBy) !== -1; }) : value;
    };
